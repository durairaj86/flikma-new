...
class CustomerStatementExport implements FromCollection, WithHeadings, WithStyles, WithEvents
{
    protected $data;
    protected $summary;
    ...
    {
        return [
            ['CUSTOMER STATEMENT SUMMARY'], // Row 1: Main Title
            ['Generated on: ' . now()->format('d-m-Y H:i')], // Row 2: Date
            [], // Row 3: Spacer
            ['Account Name:', $this->summary['name'], '', 'Opening Balance:', $this->summary['opening']], // Row 4
            ['Customer Code:', $this->summary['customer_code'], '', 'Closing Balance:', $this->summary['closing']], // Row 5
            [], // Row 6: Spacer
            ['Date', 'Voucher No', 'Voucher Type', 'reference_no', 'Job', 'Description', 'Currency', 'Exchange Rate', 'Debit', 'Credit', 'Balance'] // Row 7: Table Headers
        ];
    }
