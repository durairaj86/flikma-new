    ...
    <div class="container-fluid py-3 px-3">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0" style="font-size: 0.75rem;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Supplier Aging</li>
                        </ol>
                    </nav>
                    <h4 class="fw-bold text-dark mb-0">Supplier Aging Report</h4>
                </div>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                        ...
                        <li><a class="dropdown-item py-2 small" href="#" wire:click="exportExcel"><i class="bi bi-file-earmark-excel text-success me-2"></i> Excel (XLSX)</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="border rounded-2 mb-4 bg-light-subtle p-3">
            <div class="row g-3 align-items-center">
                ...
                <div class="col-auto">
                    <div class="d-flex align-items-center gap-2">
                        <span class="small text-muted fw-medium">Supplier:</span>
                        <select class="form-select form-select-sm border-light-subtle shadow-sm"
                                wire:model.live="supplierId" style="width: 250px;">
        ...
        <div class="report-table-wrapper">
            <livewire:report.finance.supplier-aging-table/>
        </div>
