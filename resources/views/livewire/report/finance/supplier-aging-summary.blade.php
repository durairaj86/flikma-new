...
<div class="bg-white min-vh-100">
    <div class="container-fluid py-3 px-3">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0" style="font-size: 0.75rem;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Supplier Aging Summary</li>
                        </ol>
                    </nav>
                    <h4 class="fw-bold text-dark mb-0">Supplier Aging Summary</h4>
                </div>
            </div>
        ...
        <div class="report-table-wrapper">
            <livewire:report.finance.supplier-aging-summary/>
        </div>
