@section('js', 'input_tax')
@section('page-title', 'Input Tax Report')
...
<div class="provisional-wrapper min-vh-100 bg-light py-4">
    <div class="container-fluid px-lg-5">
        ...
        <div class="row align-items-center mb-4 d-print-none">
            <div class="col-md-6">
                <h1 class="h3 fw-bold text-slate-900 mb-1">Input Tax Register</h1>
                <p class="text-muted small mb-0">
                    VAT reclaimable on purchases for {{ \Carbon\Carbon::parse($startDate)->format('d M Y') }} &mdash; {{ \Carbon\Carbon::parse($endDate)->format('d M Y') }}
                </p>
            </div>
                ...
                <div class="btn-group shadow-sm">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                            <li><a class="dropdown-item py-2" href="#" onclick="reportExportPdf(event, 'it-print')"><i class="bi bi-file-pdf text-danger me-2"></i>PDF Document</a></li>
            ...
            <div class="card-body p-4">
                <div class="row g-3 align-items-end">
                    <div class="col-lg-2 col-md-4">
                        ...
                        <input type="hidden" id="it-start-date-hidden" wire:model="startDate" value="{{ $startDate }}" />
                        <input type="text" id="it-start-date"
                    ...
                    <div class="col-lg-2 col-md-4">
                        ...
                        <input type="hidden" id="it-end-date-hidden" wire:model="endDate" value="{{ $endDate }}" />
                        <input type="text" id="it-end-date"
                               class="form-control bg-light border-0 py-2"
                               placeholder="dd-mm-yyyy"
                               value="{{ $endDate }}" />
                    </div>
        ...
        <div class="row g-3 mb-4 d-print-none">
            <div class="col-lg-6 col-md-6">
                <div class="card border-0 shadow-sm h-100 border-start border-4 border-indigo">
                    <div class="card-body p-3">
                        <div class="small text-muted fw-bold text-uppercase ls-1 mb-1">Total Input VAT</div>
                        <div class="h3 fw-bold text-indigo mb-0 tabular-nums">{{ number_format($summary['total_input_tax'], 2) }}</div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="card border-0 shadow-sm h-100 border-start border-4 border-info">
                    <div class="card-body p-3">
                        ...
                        <div class="h3 fw-bold text-info mb-0 tabular-nums">{{ $summary['transaction_count'] }}</div>
        ...
        <div class="card border-0 shadow-sm overflow-hidden">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center d-print-none">
                <h6 class="mb-0 fw-bold">
                    <i class="bi bi-journal-arrow-down me-2 text-pr"></i>
            ...
            <div>
                <livewire:report.finance.input-tax-table/>
            </div>
        </div>
    ...
    <script>
        (function () {
            ...
            function initFlatpickr() {
                var startEl = document.getElementById('it-start-date');
                var endEl   = document.getElementById('it-end-date');
                ...
                if (startEl) {
                    flatpickr(startEl, {
                        ...
                        onChange: function (selectedDates, dateStr) {
                            syncHidden('it-start-date-hidden', dateStr);
                        },
                    });
                }
                ...
                if (endEl) {
                    flatpickr(endEl, {
                        ...
                        onChange: function (selectedDates, dateStr) {
                            syncHidden('it-end-date-hidden', dateStr);
                        },
                    });
                }
            }
    ...
    <style>
        ...
        .btn-pr { background-color: var(--it-primary); border-color: var(--it-primary); color: #fff; }
        .btn-pr:hover { background-color: var(--it-dark); border-color: var(--it-dark); color: #fff; }
        .text-pr { color: var(--it-primary) !important; }
        .bg-pr-subtle { background-color: var(--it-light) !important; }
        .border-pr-subtle { border-color: #c7d2fe !important; }

        .btn-outline-pr { color: var(--it-primary); border-color: var(--it-primary); }
        .btn-outline-pr:hover, .btn-check:checked + .btn-outline-pr {
            background-color: var(--it-primary); border-color: var(--it-primary); color: #fff;
        }
