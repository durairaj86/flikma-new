                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0" style="font-size: 0.75rem;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input Tax</li>
                        </ol>
                    </nav>
                    <h4 class="fw-bold text-dark mb-0">Input Tax Report</h4>
                </div>
            </div>
                ...
                <div class="col-auto ms-auto" style="width: 300px;">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control border-start-0 ps-0"
                               placeholder="Search transactions..." wire:model.live.debounce.300ms="search">
                    </div>
                </div>
            </div>
        </div>
