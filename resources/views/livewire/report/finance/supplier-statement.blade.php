...
<div class="bg-white min-vh-100">
    <div class="container-fluid py-3 px-3">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0" style="font-size: 0.75rem;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Supplier Statement</li>
                        </ol>
                    </nav>
                    <h4 class="fw-bold text-dark mb-0">Supplier Statement</h4>
                </div>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                        <li><a class="dropdown-item py-2 small" href="#" wire:click.prevent="exportPdf"><i class="bi bi-file-pdf text-danger me-2"></i> PDF</a></li>
        ...
        <div class="report-table-wrapper">
            <livewire:report.finance.supplier-statement-table/>
        </div>
