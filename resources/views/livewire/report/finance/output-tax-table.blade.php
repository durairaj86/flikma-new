<div>
        ...
        <div class="container-fluid px-4 py-4">
            <div class="d-flex align-items-center justify-content-between mb-4 d-print-none">
                <div>
                    <h1 class="h4 fw-bold text-dark mb-1">Output Tax Register</h1>
                    <p class="text-muted small mb-0">
                        Detailed record of tax collected on sales and output transactions.
                    </p>
                </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm p-3 border-start border-4 border-success">
                        <div class="small text-muted fw-bold text-uppercase">Total Taxable Sales</div>
                        <h3 class="fw-bold mb-0 text-dark">
                            {{-- If you have taxable turnover data, place it here --}}
                            {{ isset($outputTaxData['total_taxable_value']) ? number_format($outputTaxData['total_taxable_value'], 2) : '0.00' }}
                        </h3>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm p-3 border-start border-4 border-indigo">
                        <div class="small text-muted fw-bold text-uppercase">Total Output Tax Collected</div>
                        <h2 class="fw-bold mb-0 text-indigo">
                            {{ isset($outputTaxData['total_output_tax']) ? number_format($outputTaxData['total_output_tax'], 2) : '0.00' }}
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tr>
                            <th class="ps-4 py-3">Account Information</th>
                            <th>Reference No</th>
                            <th>Date</th>
                            <th>Description</th>
                        ...
                        @else
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">
                                    <i class="bi bi-receipt-cutoff d-block fs-2 mb-2"></i>
                                    No output tax transactions recorded.
                                </td>
                            </tr>
                        @endif
                        </tbody>
                        ...
                        <tr>
                            <td colspan="4" class="ps-4 py-3 text-end text-uppercase small text-muted">Total Output Tax Liabilities</td>
                ...
                <div class="card-footer bg-white border-0 py-3 d-print-none">
                    <div class="alert alert-warning border-0 mb-0 small d-flex align-items-center">
                        <i class="bi bi-shield-check-fill me-3 fs-5"></i>
                        <div>
                            <strong>Tax Compliance:</strong> These figures represent tax liabilities on sales.
                            Ensure all ZATCA/Tax e-invoices are correctly reported to match these ledger balances.
                        </div>
                    </div>
                </div>
            </div>
