...
@section('page-title', 'Supplier Balance Summary')
...
<div class="provisional-wrapper min-vh-100 bg-light py-4">
    <div class="container-fluid px-lg-5">
        ...
        <div class="row align-items-center mb-4 d-print-none">
            <div class="col-md-6">
                <h1 class="h3 fw-bold text-slate-900 mb-1">Supplier Balance Summary</h1>
                <p class="text-muted small mb-0">Opening balance, invoiced, paid and closing balance for every supplier</p>
            </div>
                ...
                <div class="btn-group shadow-sm">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                            <li><a class="dropdown-item py-2" href="#" onclick="reportExportPdf(event, 'sbs-print', {orientation: 'landscape'})"><i class="bi bi-file-pdf text-danger me-2"></i>PDF Document</a></li>
        ...
        <div class="row g-3 mb-4 d-print-none">
            <div class="col-lg col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-3 text-center">
                        <div class="small text-muted fw-bold text-uppercase mb-1 ls-1">Suppliers</div>
            ...
            <div class="col-lg col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-3 text-center">
                        <div class="small text-muted fw-bold text-uppercase mb-1 ls-1">Paid</div>
        ...
        <div class="card border-0 shadow-sm overflow-hidden d-print-none">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-pr-subtle text-pr border border-pr-subtle px-3 py-2">
                    {{ count($rows) }} {{ Str::plural('Supplier', count($rows)) }}
                </span>
            </div>
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tr class="bg-light text-muted small text-uppercase fw-bold ls-1">
                        <th class="ps-4 border-0">Supplier</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-5 text-muted">
                                ...
                                <div class="small">No supplier balances found for the selected period.</div>
                            </td>
                        </tr>
                    @endforelse
                    </tbody>
                    ...
                    <tr class="fw-bold">
                        <td class="ps-4 py-3">{{ count($rows) }} Suppliers</td>
        ...
        <div id="sbs-print" class="stmt-print d-none d-print-block"
            ...
            <table class="stmt-meta">
                <tr>
                    ...
                    <td class="text-end">
                        <div class="stmt-title">SUPPLIER BALANCE SUMMARY</div>
            ...
            <table class="stmt-table">
                ...
                @empty
                    <tr><td colspan="5" class="text-center">No supplier balances found for the selected period.</td></tr>
                @endforelse
                </tbody>
                <tfoot>
                <tr class="stmt-strong">
                    <td>{{ count($rows) }} Suppliers</td>
