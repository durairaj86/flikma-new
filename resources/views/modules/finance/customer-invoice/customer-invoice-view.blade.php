<div class="offcanvas offcanvas-end customer-drawer" tabindex="-1" id="moduleDrawer" style="width: 60%;">
    <div class="offcanvas-header border-bottom bg-light px-4 py-3 d-flex justify-content-between align-items-center">
        <div>
            <h5 id="moduleDrawerLabel" class="mb-0 fw-bold">Customer Invoice Details</h5>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="paymentHistoryDrawer" style="width: 35%;">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title mb-0">Payment History</h5>
        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
