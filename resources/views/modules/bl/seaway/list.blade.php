@section('js','seaway_bill')
@section('page-title','Seaway Bill')
<x-app-layout>
    <main class="gmail-content bg-white px-3">
                    ...
                    <div class="bg-light rounded p-3 mb-4">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-4 form-filter">
                                <label class="form-label fw-medium">Seaway Bill Date</label>
        ...
        <div class="shadow bdr-r-10 py-3 flex-grow-1">
            ...
            <div class="">
                <table class="table align-middle dataTable" id="dataTable" data-min-height="min-height:75vh;" data-title="Seaway Bill" data-model-size="lg">
                    <thead class="table-light bg-white">
                    <tr>
                        <th>Seaway Bill No</th>
                        <th>Customer</th>
                        <th>Job No</th>
