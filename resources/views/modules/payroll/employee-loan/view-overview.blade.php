...
@section('print-content')
    ...
    <div class="container-fluid">
        @if($employeeLoan->status == 'rejected')
            <div class="draft-watermark">REJECTED</div>
        ...
        <div class="no-print d-flex justify-content-end mb-3">
            <button type="button" class="btn btn-dark btn-sm"
                ...
                <i class="bi bi-printer me-1"></i> Print Loan Details
            </button>
        </div>
        ...
        <div class="employee-details">
            <div class="employee-info">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ $employeeLoan->employee->department->name ?? 'N/A' }}</div>
                </div>
                <div class="info-row">
