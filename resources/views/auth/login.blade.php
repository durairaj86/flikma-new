<x-guest-layout>
                ...
                <div class="max-w-md text-center">
                    ...
                    <div class="mt-5 d-flex gap-4 justify-content-center">
                        <div class="text-center">
                            <h4 class="mb-0 fw-bold">99.9%</h4>
                            <small class="opacity-50">Uptime</small>
                        </div>
                        <div class="vr"></div>
                        <div class="text-center">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="small text-finance text-decoration-none fw-medium">
                                    Forgot Password?
                                </a>
                            @endif
                        </div>
    ...
    <style>
        :root {
            --finance-primary: #0d9488; /* Teal 600 */
            --finance-dark: #0f172a;    /* Slate 900 */
        }
        ...
        /* Subtle background pattern for the dark side */
        .bg-finance::before {
            content: "";
            position: absolute;
            width: 200%;
